...
from relay_teams.agent_runtimes.instances.ids import new_instance_id
...
class SubAgentInstance(BaseModel):
    """Compatibility projection for older subagent launch code.

    New persistence should use AgentRuntimeRecord. This model remains as the
    lightweight identity payload returned by create_subagent_instance while
    launch paths are migrated incrementally.
    """

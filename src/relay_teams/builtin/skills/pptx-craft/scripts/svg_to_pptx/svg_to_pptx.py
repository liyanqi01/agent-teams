...
Usage:
    python3 scripts/svg_to_pptx/svg_to_pptx.py <project_path>
    python3 scripts/svg_to_pptx/svg_to_pptx.py <project_path> -o output.pptx
    python3 scripts/svg_to_pptx/svg_to_pptx.py <project_path> --use-final

Examples:
    python3 scripts/svg_to_pptx/svg_to_pptx.py examples/ppt169_demo
    python3 scripts/svg_to_pptx/svg_to_pptx.py examples/ppt169_demo -o presentation.pptx
    python3 scripts/svg_to_pptx/svg_to_pptx.py examples/ppt169_demo --use-final
